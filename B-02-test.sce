...
#
# STATUS
# This was an unconfirmed first transcription attempt.
# It does not reproduce the printed example correctly yet.
...
; save 'B-02-test.lst';
/RUN
goto 0 0 r/s 0 . 5 r/s 2 . 5 r/s 3 r/s 6 r/s 8 r/s 5 r/s 2 r/s 1 r/s skp r/s
